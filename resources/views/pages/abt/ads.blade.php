	...
	<div class="modal-dialog">
		<div class="modal-content text-center" style="background-image: url(<?= asset('images/adspopup.png')?>); background-repeat: no-repeat; width:84%;">
			...
			<div class="container" style="position:absolute; background-color: white; border-radius: 7px;bottom: 0%;width: 100%;height: 16%;"> 
				<img style="background-image: url(<?= asset('images/google-play-badge.png')?>); width: 128px; height: 38px;border-radius: 8px; margin-bottom: 5px; margin-top: 3%" href="#">
				<img style="background-image: url(<?= asset('images/app-store-badge.png')?>); width: 128px; height: 38px;border-radius: 8px; margin-top: 3%" href="#">
			</div>
		</div>
	</div>
</div>
