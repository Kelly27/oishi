        ...
        <div class="row">
            <div class="col-sm-4 m-nopadding" >
                ...
                <img src="{{URL::to('images/img4.png')}}" class="img-responsive">
                    ...
                    <p class="nopadding" style="font-size:x-small; ">0 Bought | Unilimited</p>
                    <p class="nopadding text-right" style="font-size: x-small;text-decoration: line-through; color: #6D6E71">RM110.00</p>
