<div class="container">
            ...
            <div class="col-sm-4 m-nopadding">
                <div class="container reward-cont" >
                    <div style="max-height: 240px; overflow: hidden;">
                        <a href="{{ route('reward.id', ['reward_id' => $reward->id]) }}"><img src="{{ asset('images') }}/{{$reward->image}}" class="img-responsive"></a>
                        @if ($reward->tag === 1)
                    ...
                    <a href="{{ route('reward.id', ['reward_id' => $reward->id]) }}" class="eli-1line" style="-webkit-line-clamp:1; font-weight: bold; color: black;"><img src="{{URL::to('images/hand.png')}}" style="margin: 10px"> {{$reward->title}} </a>
                </div>
            </div>
        @endforeach
    </div>
    <div class="row">
        <div class="col-sm-12 text-right" style="margin: 5px 0px 5px">
            <a href="{{ route('reward') }}" style="color: #1B75BB; font-weight: bold; font-family: Arial;">SEE MORE >></a>
        </div>
    </div>
</div>